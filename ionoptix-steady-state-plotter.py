...
folder = 'C:/Users/15189/Desktop/MA 2.1.5 Board Thermal Testing/Ionoptix-Steady-State-Recordings/'


filenames = [
             # 'Ionoptix_Steady_State_4V_4Hz_2ms.csv',
             # 'Ionoptix_Steady_State_4V_1Hz_10ms.csv',
             'Ionoptix_Steady_State_10V_1Hz_10ms.csv',
             # 'Ionoptix_Steady_State_4V_6Hz_6.4ms.csv',
             # 'Ionoptix_Steady_State_10V_6Hz_6.4ms.csv', 
             'Ionoptix_1V_10V_10ms_CoolingPlate_36.0C_SensorOnBoard.csv',
            ]
...
for file in filenames:
    ...
    df = pd.read_csv(folder + file, sep=',', index_col=0, usecols=[0,1,3,4])
    ...
    df_tps.plot(
        ...
        title='Ionoptix C-Pace EM Stimulator\n'+titleString,
        grid=True)
...
fig.suptitle('IONOPTIX C-PACE EM STIMULATOR\n')